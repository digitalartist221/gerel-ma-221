...
<div class="space-y-10 animate-in fade-in duration-700">
    ...
    <div class="p-6 md:p-12 rounded-[2rem] md:rounded-[3rem] bg-white border border-slate-100 shadow-sm overflow-hidden text-slate-900 notebook-edge">
        <div class="flex items-center justify-between mb-8">
            <h2 class="text-xl font-black text-slate-900 tracking-tight">Liste des clients</h2>
            <div class="relative w-full max-w-xs">
                <input type="text" id="searchInput" onkeyup="filterTable('clientsTable')" placeholder="Rechercher..." class="w-full bg-slate-50 border border-slate-100 rounded-full px-6 py-3 text-sm font-bold focus:ring-2 focus:ring-brand-500 outline-none transition-all pl-12">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left" id="clientsTable">
                <thead>
